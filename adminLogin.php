    ...
    <body>
        ...
        if ($_SERVER['REQUEST_METHOD']== 'POST')
        {
            ...
            if ($id && $p)
            {
                ...
                //count the number of roes that match the adminID/adminPassword combination
        ...
        <div class="container">
            ...
            <lebal for="adminPassword"><b>Password:</b></label>
        ...
        <div>
            ...
            <a href="adminRegister.php" style="color: black">Sign Up</a>
            </label>
        </div>
