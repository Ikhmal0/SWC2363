<html>
    ...
    <body>
        ...
        if ($_SERVER['REQUEST_METHOD']== 'POST')
        {
            ...
            {
                //make the query
                $q = "DELETE FROM student WHERE studentID = $id LIMIT 1";
            ...
            {
                echo '<script>alert("The student has NOT been deleted");
                window.location.href="studentList.php";</script>';
            }
        }
        else
        {
            ...
            $q = "SELECT studentName FROM student WHERE studentID = $id";
            $result = @mysqli_query ($connect, $q);// run the query
