...
/* Style the buttons inside the timeTable  */
.timeTable  button {
...
/* Create an active/current timeTable link class */
.timeTable  button.active {
 background-color: #ccc;
 }

/* Style the timeTable  content */
.timeTable content {
 display: none;
 padding: 6px 12px;
 border: 1px solid #ccc;
...
<div class="dropdown-content">
 ...
 <div id="stimeTable" class="tabcontent">
 <button class="tablinks" onclick="openTimeTable(event, 'CC101')">CC101</button>
 <div id="CC101" class="tabcontent">
 <h3>CC101</h3>
 ...
 if (mysqli_num_rows($result) > 0) {
  {
 echo "<img align='center' src='gambar/jadual1.jpg"  . "' alt='' style='height: 350px;'>";
 }
 } else {
 echo "No time table found.";
 }
 ...
 <button class="tablinks" onclick="openTimeTable(event, 'CT201')">CT201</button>
 <div id="CT201" class="tabcontent">
 <h3>CT201</h3>
 <?php
 include 'header.php';
 ...
 if (mysqli_num_rows($result) > 0) {
  {
 echo "<img align='center' src='gambar/jadual3.jpg"  . "' alt='' style='height: 350px;'>";
 }
 } else {
 echo "No time table found.";
 }
 ...
 <button class="tablinks" onclick="openTimeTable(event, 'BE101')">BE101</button>
 <div id="BE101" class="tabcontent">
 <h3>BE101</h3>
 <?php
 include 'header.php';
 ...
 if (mysqli_num_rows($result) > 0) {
  {
 echo "<img align='center' src='gambar/jadual4.jpg"  . "' alt='' style='height: 350px;'>";
 }
 } else {
 echo "No time table found.";
 }
 ...
 function openTimeTable(evt, courseCode) {
 var i, tabcontent, tablinks;
 tabcontent = document.getElementsByClassName("tabcontent");
 for (i = 0; i < tabcontent.length; i++) {
 tabcontent[i].style.display = "none";
