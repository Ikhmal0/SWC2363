<html>
    ...
    <body>
        ...
        if ($_SERVER['REQUEST_METHOD']== 'POST')
        {
            ...
            {
                $id = mysqli_real_escape_string($connect, $_POST['studentID']);
            ...
            //validate the studentPassword
            if (!empty($_POST['studentPassword']))
            {
                $p = mysqli_real_escape_string($connect, $_POST['studentPassword']);
            }
            else
            {
                $p = FALSE;
            ...
            if ($id && $p)
            {
                //Retrieve the studentID, studentPassword, studentName, studentPhoneNo, studentEmail
                $q = "SELECT studentID, studentPassword, studentName, studentIC,
                courseCode, studentPhoneNo, studentEmail, studentAddress
                FROM student WHERE (studentID ='$id' AND
                studentPassword ='$p')";

                //run the query and assign it to the variable $result
                $result = mysqli_query ($connect, $q);

                //count the number of roes that match the studentID/studentPassword combination
                ...
                {
                    echo '<p class ="error"> The studentID and studentPassword entered do not match our records
        ...
        <div class="container">
            ...
            <button type="submit" value="search">Login</button>
        ...
        <div>
            ...
            <a href="studentRegister.php">Sign Up</a>
            </label>
        </div>
